...
<template>
  ...
  >
    ...
    <div
      class="mt-8 w-full max-w-lg bg-black text-green-400 p-4 rounded font-mono text-sm shadow-lg border-2 border-green-600"
    >
      <h3 class="font-bold border-b border-green-600 mb-2 pb-1">
        LOGS DO SISTEMA:
      </h3>
